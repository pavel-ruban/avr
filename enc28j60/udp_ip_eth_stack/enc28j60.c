...
{
	// Initialize SPI
	ENC28J60_SPI_DDR = ENC28J60_SPI_CS|ENC28J60_SPI_MOSI|ENC28J60_SPI_SCK|1<<2;
	enc28j60_release();
	...
	uint8_t revision = enc28j60_rcr(EREVID);
	*term_var_info = revision;
	*(term_var_info + 1) = 0xbb;
	*(term_var_info + 2) = 0x00;
}
